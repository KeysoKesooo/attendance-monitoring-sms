...
<body>
    ...
    <div class="container">
        ...
        <!-- Image carousel for background effect -->
        <div class="login-image">
            <img src="/TMCSHS/images/image1.jpg" alt="Image 2" class="fade-image">
            <img src="/TMCSHS/images/image2.jpg" alt="Image 2" class="fade-image">
            <img src="/TMCSHS/images/image3.jpg" alt="Image 2" class="fade-image">
            <img src="/TMCSHS/images/image4.jpg" alt="Image 2" class="fade-image">
        ...
        <form class="form" method="post" action="auth.php">
            <!-- Logo at the top -->
            <div class="logo">
                <img src="/TMCSHS/images/school_logo.png" alt="Logo">
            </div>
            <div class="title">
